...
# ╔═╡ dbe7dc6b-36f5-4256-b4ab-7bea375dbddb
begin
...
# ╔═╡ af189800-ee8e-4042-9a76-89a60e8a6b21
using StatsBase
...
# ╔═╡ 59339943-737f-4860-8570-fc54b789d6f0
TableOfContents()   # from PlutoUI

# ╔═╡ 491930cc-1afa-431b-b1f9-2defd8c41e4a
@htl("""
...
# ╔═╡ dd81e560-4c45-4435-a9e8-27dd819af1a2
md"""
## Introduction
"""
...
df_pi = DataFrame(sqrt_radius= 1:130) #73 is the magic number

# ╔═╡ 5411e5e7-5a47-498e-9cbe-884d6d5df661
begin
...
# ╔═╡ dc84ccf7-512c-4287-9fbe-f51bc92c480c
begin
	xₜ(t) = sin(t)
	yₜ(t) = sin(2t)
	Plots.plot(xₜ, yₜ, 0, 2π, leg=false, fill=(0,:orange))
end

# ╔═╡ 31cdd855-d005-463e-883f-c5c7290b003b
function circleShape(h,k,r)
	Θ = LinRange(0,2*π, 500)
	h .+ r*sin.(Θ), k .+ r*cos.(Θ)
end

# ╔═╡ ad58065c-4d96-49bf-ad2e-c1a5b2beba9b
Plots.plot(circleShape(0,0,1), seriestype = [:shape,])
...
# ╔═╡ aeb84e54-a368-4da1-a6a0-56d2463ed0a1
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "e8271b6e3615473e8df8805e5d6aff996efd25e8"
